...
<body>
    ...
    ?>
    <form action="update_producto.php" method="post" enctype="multipart/form-data" onsubmit="verificarEntImagen()">
        <fieldset>
            <legend>Información Producto</legend>
            <label for="id">Id:</label><br>
            <input type="text" id="id" name="id" readonly value="<?php echo $idProducto; ?>" /><br /><br />
